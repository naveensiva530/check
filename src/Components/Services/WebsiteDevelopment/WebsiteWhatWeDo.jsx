...
const services = [
  {
    ...
    desc: "Professional websites designed to communicate what your business does clearly and give visitors a reason to take action.",
    img: imgBusiness
  },
  {
    num: "02",
    title: "Landing Pages",
    desc: "Focused pages designed around a specific campaign, offer, audience, or conversion objective.",
    img: imgLanding
  },
  {
    num: "03",
    title: "Corporate Websites",
    desc: "Structured digital experiences for organisations that need clear information architecture, credibility, and scalable content.",
    img: imgCorporate
  },
  {
    num: "04",
    title: "Startup Websites",
    desc: "Lean, flexible websites that help emerging businesses explain their proposition and establish a credible digital presence.",
    img: imgStartup
  },
  {
    num: "05",
    title: "SaaS & Technology Websites",
    desc: "Product-focused experiences that make complex technology easier to understand, evaluate, and explore.",
    img: imgSaaS
  },
  {
    num: "06",
    title: "Service Websites",
    desc: "Websites that organise multiple services into clear journeys so visitors can quickly find the solution relevant to them.",
    img: imgService
  },
  {
    num: "07",
    title: "Website Redesigns",
    desc: "Rework outdated websites around modern UX, clearer content, responsive design, stronger performance, and better conversion paths.",
    img: imgRedesign
  },
  {
    num: "08",
    title: "Conversion-Focused Pages",
    desc: "Pages structured to reduce confusion, strengthen trust, and make the intended next action obvious.",
    img: imgConversion
  },
];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
          ...
          <div className="flex-1 text-center lg:text-left relative z-10">
            ...
            <p className="text-[17px] leading-relaxed text-slate-600 mt-6 mb-10 max-w-xl mx-auto lg:mx-0 font-medium">
              Website development services designed around real business needs — every type of site, built to work.
            </p>
