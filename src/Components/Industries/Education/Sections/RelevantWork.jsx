  ...
  return (
    <section className="w-full bg-white py-16 md:py-24 px-4 md:px-8" style={{ fontFamily: "var(--font-primary)" }}>
      <div className="max-w-[1200px] mx-auto">
        ...
        <ScrollRevealHeading justify="center" maxW="900px" className="mx-auto mb-12" words={[{ text: 'Education', italic: true }, { text: 'Case' }, { text: 'Studies' }]} />
        ...
        <div className="bg-[var(--bg-light-purple)] rounded-[24px] p-8 md:p-12 border-2 border-purple-200/80 shadow-sm">
          <div className="mb-6">
            <h3 className="text-xl md:text-2xl font-extrabold text-[var(--brand-navy)] mb-2">
              BrightPath Learning Institute
            </h3>
            <div className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-slate-600 mb-4">
              <span><strong>Industry:</strong> Education</span>
              <span><strong>Service:</strong> Digital Marketing & Social Media</span>
            </div>
            <div className="text-slate-700 mb-4 space-y-4">
              <p><strong>Challenge:</strong> The institute needed a clearer digital presence to communicate its programmes and reach prospective students and parents.</p>
              <p><strong>Approach:</strong> ADSSERV developed audience-focused content, social media communication and digital messaging around programme discovery, information and enquiry.</p>
              <p><strong>Outcome:</strong> Created a more structured digital communication journey from programme awareness to enquiry.</p>
            </div>
          </div>
