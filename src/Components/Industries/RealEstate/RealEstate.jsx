...
import DigitalJourney from './Sections/DigitalJourney';

// Data
import {
  heroData, problemData, approachData, whatWeDoData,
  journeyData, faqData, ctaData
} from './RealEstateData';
...
export default function RealEstate() {
  ...
  return (
    <div className="font-sans bg-white min-h-screen flex flex-col">
      ...
      {/* 5. THE DIGITAL PROPERTY JOURNEY */}
      <DigitalJourney {...journeyData} />
